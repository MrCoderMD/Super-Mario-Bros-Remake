...
const invisible_blocks=[Vector2i(107,5),Vector2i(110,5),Vector2i(113,5),Vector2i(106,9),Vector2i(109,9),Vector2i(112,9)]
const powerupcoords=[Vector2i(30,6)]
const lifeupcoords=[]
...
func _process(_delta: float) -> void:
	...
	if mario:
		if final:
			if mario.global_position.x<final.global_position.x+821.5:
